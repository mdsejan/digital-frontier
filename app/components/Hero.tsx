            ...
            <div className="flex items-center flex-wrap mb-20">
              <div className="w-full md:w-1/2 pr-10">
                ...
                <p className="text-gray-600 mb-8">
                  Their primary target will be the power generators. Prepare to
                  open the shield. Sir, Rebel ships are coming into our sector.
                  Good. Our first catch of the day. Stand by, ion
